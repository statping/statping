...
<a href="https://github.com/aboutcher/statping-ng/wiki">View Wiki</a> | <a href="https://demo.statping.com">Demo</a> | <a href="https://itunes.apple.com/us/app/apple-store/id1445513219">iPhone</a> | <a href="https://play.google.com/store/apps/details?id=com.statping">Android</a> <br> <a href="http://docs.statping.com">API</a> | <a href="https://github.com/aboutcher/statping-ng/wiki/Docker">Docker</a> | <a href="https://github.com/aboutcher/statping-ng/wiki/AWS-EC2">EC2</a> | <a href="https://github.com/aboutcher/statping-ng/wiki/Mac">Mac</a> | <a href="https://github.com/aboutcher/statping-ng/wiki/Linux">Linux</a> | <a href="https://github.com/aboutcher/statping-ng/wiki/Windows">Windows</a>
</p>

# Statping-ng - Status Page & Monitoring Server
An easy to use Status Page for your websites and applications. Statping will automatically fetch the application and render a beautiful status page with tons of features for you to build an even better status page. This Status Page generator allows you to use MySQL, Postgres, or SQLite on multiple operating systems.

![Master Release](https://github.com/aboutcher/statping-ng/workflows/Master%20Release/badge.svg?branch=master) [![GoDoc](https://godoc.org/github.com/golang/gddo?status.svg)](https://godoc.org/github.com/adamboutcher/statping-ng) [![Slack](https://slack.statping.com/badge.svg)](https://slack.statping.com) [![](https://images.microbadger.com/badges/image/adamboutcher/statping-ng.svg)](https://microbadger.com/images/adamboutcher/statping-ng) [![Docker Pulls](https://img.shields.io/docker/pulls/statping/statping.svg)](https://hub.docker.com/r/statping/statping/builds/)
...
<br><br>
<p align="center">
    <a href="https://github.com/aboutcher/statping-ng/wiki/Linux"><img width="5%" src="https://img.cjx.io/linux.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="https://github.com/aboutcher/statping-ng/wiki/Mac"><img width="5%" src="https://img.cjx.io/apple.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="https://github.com/aboutcher/statping-ng/wiki/Windows"><img width="5%" src="https://img.cjx.io/windows.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
## Run on Any Server
Whether you're a Docker fan-boy or a [AWS EC2](https://github.com/aboutcher/statping-ng/wiki/AWS-EC2) master, Statping gives you multiple options to simply get running. Our Amazon AMI image is only 8Gb and will automatically update to the most stable version of Statping.
...
View the [Plugin Wiki](https://github.com/aboutcher/statping-ng/wiki/Statping-Plugins) to see detailed information about Golang Plugins. Statping isn't just another Status Page for your applications, it's a framework that allows you to create your own plugins to interact with every element of your status page. [Notifier's](https://github.com/aboutcher/statping-ng/wiki/Notifiers) can also be create with only 1 golang file.
<br><br><br><br>
...
## Run on Docker
Use the [Statping Docker Image](https://hub.docker.com/r/statping/statping) to create a status page in seconds. Checkout the [Docker Wiki](https://github.com/aboutcher/statping-ng/wiki/Docker) to view more details on how to get started using Docker.
```bash
...
## Run on EC2 Server
Running Statping on the smallest EC2 server is very quick using the AWS AMI Image. Checkout the [AWS Wiki](https://github.com/aboutcher/statping-ng/wiki/AWS-EC2) to see a step by step guide on how to get your EC2 Statping service online.
<br><br><br><br>
