...
const (
	...
	alertingTemplate = `{ "attachments": [ { "fallback": "Service {{.Service.Name}} - is currently alerting", "text": "{{.Service.Name}} is currently alerting.", "fields": [ { "title": "Expected Status Code", "value": "{{.Service.ExpectedStatus}}", "short": true }, { "title": "Received Status Code", "value": "{{.Service.LastStatusCode}}", "short": true } ,{ "title": "Error Message", "value": "{{.Issue}}", "short": false } ], "color": "#F7A100", "thumb_url": "https://statping.com", "footer": "Statping", "footer_icon": "https://img.cjx.io/statuplogo32.png" } ] }`
