const german = {
    ...
    request_timeout: "Anfrage Zeitüberschreitung",
    ...
    hour: "Stunde",
    minute: "Minute",
    failures_24_hours: "Ausfälle innerhalb der letzten 24 Stunden",
    ...
    project_name: "Name der Status-Seite",
    description: "Beschreibung",
    domain: "Domäne",
    enable_cdn: "CDN aktivieren",
    newsletter: "Newsletter",
    newsletter_note: "Wir senden Ihnen nur bei größeren Änderungen eine E-Mail.",
    loading: "Laden",
    ...
    assets_desc: "Passen Sie das Design Ihrer Statusseite an, indem Sie lokale Assets aktivieren. Dadurch wird ein Verzeichnis „Assets“ erstellt, das alle CSS-Dateien enthält.",
    ...
    service_timeout: "Dienst Timeout",
    ...
    notify_all: "Bei allen Änderungen benachrichtigen",
