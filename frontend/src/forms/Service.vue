        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            ...
            <small class="form-text text-muted"
              >Give your service a name you can recognize</small
            >
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <select v-model.number="service.group_id" class="form-control">
              ...
              <option
                v-bind:key="index"
                v-for="(group, index) in $store.getters.cleanGroups()"
                :value="group.id"
                >{{ group.name }}</option
              >
            </select>
            <small class="form-text text-muted"
              >Attach this service to a group</small
            >
          </div>
        </div>
        <div class="form-group row">
